export default function ScreenshotHelp() {
  return (
    <div style={{ maxWidth: '800px', margin: '2rem auto', padding: '1rem', fontFamily: 'Arial, sans-serif' }}>
      ...
      <ul>
        ...
        <li><strong>Window:</strong> Press <code>Command (⌘) + Shift + 4</code>, then Spacebar</li>
      </ul>
      ...
      <h2>Android</h2>
      <ul>
        <li>Most phones: Press <code>Power Button + Volume Down</code></li>
        <li>Some models: Swipe with three fingers or use Assistant</li>
      </ul>
